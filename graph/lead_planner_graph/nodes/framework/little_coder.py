...
The little-coder integration the ``delegate`` node plugs into, and the default
``run_command`` / ``run_tests`` for ``NodeDeps``. It lives in the framework
because it is scaffolding, not a node.
